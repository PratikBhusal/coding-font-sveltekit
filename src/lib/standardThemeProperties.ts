import type { ThemeProperties } from '@skeletonlabs/tw-plugin';

export type StandardThemeProperty = keyof ThemeProperties;

export const standardThemeProperties: ThemeProperties = {
  // =~= Theme Properties =~=
